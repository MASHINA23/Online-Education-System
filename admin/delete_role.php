...
<br></font><br><br><a href='view_roles.php'><img src='../uploads/back.png' alt='BACK' ></a></center>";
            mysql_close($conn);
         }else {
			...
			<br><br><br><br><br><br>
               <form method = "post" action = "<?php $_PHP_SELF ?>">
                  <table width = "600" border = "0" cellspacing = "1" 
                     ...
                     <tr>
<td width = "100"> </td>
 <td><font color="#17202A" size="4 px"> Are you sure you want to delete<br> <b>
                     ...
                     <tr>
                        ...
                        <td>
                           <button name = "delete" type = "submit" 
                              id = "delete" class="deletebtn">Delete Role</button>
                        </td>
                     </tr>
                     <tr>
                         <td width = "100"> </td>
